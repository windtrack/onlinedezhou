#ifndef __SNGRANKLIST_H__
#define __SNGRANKLIST_H__
...
class SngRankList : public GameDialog
{
public:
	SngRankList();
	~SngRankList();
	CREATE_FUNC(SngRankList);
	// 更新函数
...
protected:
	...
	struct UserWinPotListItem			// 玩家赢得奖金
	{
		...
		cocos2d::Sprite		*m_pSpriteScoreImage;	// 玩家的奖金精灵图片
	...
	// 更新奖金的列表
	void UpdateUserWinPotListItem(SngRankList::UserWinPotListItem *item, const SngRankInfo& rankuserinfo);

	// 更新底池的列表
	void UpdateUserWinCashListItem(SngRankList::UserWinCashListItem *item, const SngRankInfo& rankuserinfo);	
...
private:
	...
	MenuItemSpriteWithLabel						*m_pFriendsWorldMenu[3];						// 好友排名排行榜下的所有按钮
