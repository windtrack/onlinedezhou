...
namespace jsonrpc
{
    ...
    void HttpClient::SendRQMessage(const std::string& message,const std::string &agent, std::string& result) throw (JsonRpcException)
    {
        CURLcode res;
		...
		headers = curl_slist_append(headers, agent.c_str());//User-Agent: NN100 0058/1.0
