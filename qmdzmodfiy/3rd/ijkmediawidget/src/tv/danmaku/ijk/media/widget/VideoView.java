...
public class VideoView extends SurfaceView implements
    ...
    private OptionDelegate optDelegate = null;
    public void setDelegate(OptionDelegate delegate)
    {
    	optDelegate = delegate;
    }
    
    private HideDelegate hideDelegate = null;
    public void setHideDelegate(HideDelegate delegate)
    {
    ...
    public void setVideoLayout(int layout) {
        ...
        if (mVideoHeight > 0 && mVideoWidth > 0) {
            ...
            Log.i(">>>>>>>>>>>>>>", mSurfaceHeight + "" + mSurfaceWidth);
            ...
            lp.width = (int)(192 * ratio);
            lp.height = (int)(144 * ratio);
            setLayoutParams(lp);
    ...
    public void setMute(int leftVol, int rightVol)
    {
    	if (mMediaPlayer != null) {
...
//            toggleMediaControlsVisiblity();
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	...
    	if (optDelegate != null) 
    		return optDelegate.onKeyDown1(keyCode, event);
